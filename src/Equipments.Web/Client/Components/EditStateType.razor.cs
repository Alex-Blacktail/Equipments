...
{
    public partial class EditStateType
    {
        [Inject]
        ...
        {
            var dataType = await httpClient.GetFromJsonAsync<DataType>(Routing.StateTypes + Id);
        ...
        private async Task FormSubmit()
        {
            try
            {
                await httpClient.PutAsJsonAsync(Routing.StateTypes + Id, typeDto);
