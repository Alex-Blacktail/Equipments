...
{
    public partial class EditEquipmentType
    {
        [Inject]
        ...
        {
            var dataType = await httpClient.GetFromJsonAsync<DataType>(Routing.EquipmentTypes + Id);
        ...
        private async Task FormSubmit()
        {
            try
            {
                await httpClient.PutAsJsonAsync(Routing.EquipmentTypes + Id, typeDto);
