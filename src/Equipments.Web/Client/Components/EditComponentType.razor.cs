...
{
    public partial class EditComponentType
    {
        [Inject]
        ...
        {
            var dataType = await httpClient.GetFromJsonAsync<DataType>(Routing.ComponentTypes + Id);
        ...
        private async Task FormSubmit()
        {
            try
            {
                await httpClient.PutAsJsonAsync(Routing.ComponentTypes + Id, typeDto);
